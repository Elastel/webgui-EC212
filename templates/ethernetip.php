            ...
            <?php echo \ElastPro\Tokens\CSRF::hiddenField(); ?>
              ...
              <div class="cbi-section cbi-tblsection" id="page_ethernetip" name="page_ethernetip">
                ...
                $arr= array(
                  ...
                  array("name"=>"Tag Addressing",       "style"=>"", "descr"=>"", "ctl"=>"input"),
                ...
                <div class="cbi-section-create">
                  <input type="button" class="cbi-button-add" name="popBox" value="Add" onclick="addData('ethernetip')">
                  <?php conf_im_ex('EtherNet/IP'); ?>
                </div>
              </div>
            <?php echo $buttons ?>
          </form>
...
<div id="popBox" style="overflow:auto">
  ...
  <h4><?php echo _("EtherNet/IP Rules Object Setting"); ?></h4>
